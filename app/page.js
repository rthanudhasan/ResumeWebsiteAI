        ...
        <section className="work-experience container">
          ...
          <div className="jobs">
				<article>
					...
					<div style="font-size: 14px; font-style: italic;">May 2024 – Till Date</div>
					<p style="font-size: 14px;">Implemented RPA automation for Fixed Assets and Accounts Payable teams, utilizing tools like ABBYY, Appzen, and UiPath. Successfully optimized business processes, achieving 95% automation success rates through efficient exception handling and API integration.</p>
				</article>
				<article>
					<figure>
						<div>
					...
					<div style="font-size: 14px; font-style: italic;">June 2019 – May 2024</div>
					<p style="font-size: 14px;">Collaborated with senior leaders to design and implement RPA solutions, reducing annual expenses by $500,000 and generating over $1 million in revenue. Successfully optimized business processes, improving efficiency by 35% on average, and maintained high data quality and accuracy through API integration and best practices.</p>
				</article>
				<article>
					<figure>
						<div>
				...
				<article>
					...
					<div style="font-size: 14px; font-style: italic;">June 2016 – August 2016</div>
					<p style="font-size: 14px;">Implemented end-to-end RPA solutions using UiPath, automating manual processes and integrating various applications. Collaborated with cross-functional teams to develop and deliver product features, managed backlogs, and ensured successful User Acceptance Testing (UAT) and user adoption.</p>
				</article>
				<article>
					<figure>
						<div>
					...
					<h5>Analyst</h5>
					<div style="font-size: 14px; font-style: italic;">December 2011 – July 2015</div>
					<p style="font-size: 14px;">Led a team of junior analysts and managed functional design across multiple product lines, utilizing Waterfall and Agile methodologies. Designed and implemented RPA solutions, engineered product designs, and provided training and support, ensuring seamless integration of technical and business processes.</p>
				</article>            
          </div>
        </section>
        <section id="education" class="work-experience container">
          ...
          <div class="jobs">
				...
				<article>
					...
					<div style="font-size: 14px; font-style: italic;">June 2007 – May 2011</div>
					<p style="font-size: 14px;">Earned a Bachelor of Technology in Computer Science and Engineering, establishing a solid foundation in computer science principles and software engineering methodologies. Completed undergraduate coursework in a range of technical areas, including Software Engineering, Data Structures, Algorithms, Computer Architecture, and Business Intelligence, preparing for a career in software development and technology management.</p>
				</article>
          </div>
        </section>
